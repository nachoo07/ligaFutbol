        ...
        <div className="receipt-container">
            ...
            <div className="receipt-header">
                <div className="receipt-header-logo">
                    <img
                        src={logoUrl || 'https://res.cloudinary.com/dmjjwnvq8/image/upload/v1742739966/logo_nuc99w.png'}
            ...
            <div className="receipt-content">
                ...
                <div style={{ marginBottom: '10px' }}></div> {/* Añadir gap de 10px */}
                ...
                <div className="receipt-section">
                    ...
                    <p className="receipt-text">
                        <strong>Fecha de Pago:</strong> {formatDate(share.paymentDate || share.updatedAt)}
                    </p>
                </div>
            </div>
